...
plan: "04"
subsystem: docs
tags: [operator-checklist, exit-gate, v03, deployment, bench-jetson]

# Dependency graph
requires:
  - phase: 05.1-deb-packaging-hotfix
    provides: "05.1-CONTEXT.md V-03 step definitions (L-162..173)"
  - phase: 05-bench-field-shadow
    provides: "SIGNOFF.md canonical operator checklist shape"
provides:
...
affects:
  - "Phase 05 Plan 08 (bench soak window — blocked until EXIT-CHECKLIST.md committed + filled)"
  - "Phase 06 entry (downstream of bench soak)"

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Operator-filled Markdown checklist as phase-exit gate (mirrors SIGNOFF.md shape)"
