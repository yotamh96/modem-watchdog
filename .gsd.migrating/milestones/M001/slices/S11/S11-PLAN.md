...
- [x] **T01: ADR-0014 and health-gate PromQL definitions** `est:30min`
...
- [x] **T02: MIGRATION.md rewrite for v1-retired reality** `est:45min`
...
- [x] **T03: Post-cutover validation script** `est:45min`
...
- [x] **T04: Cutover runbook, communication templates, and stale-doc cleanup** `est:40min`
...
- [x] **T05: Cross-document consistency verification** `est:15min`
